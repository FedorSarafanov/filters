...
\draw (0,0) to [american inductor=$L_1/2$] (2,0) to [capacitor=$2C_1$]  (4,0)--
(4,-1)--(3,-1) (3,-3) to [american inductor=$L_2$] (3,-1) (3,-3) -- (4,-3) -- (4,-4)--(0,-4);
\draw (8,-4)--(4,-4) --(4,-3)--(5,-3) to [capacitor,l_=$C_2$] (5,-1)--(4,-1)--(4,0) to [capacitor=$2C_1$] (6,0) to [american inductor=$L_1/2$] (8,0);
