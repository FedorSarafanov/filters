...
\draw (0,0)--(2,0)--(2,-1)--(1,-1) (1,-3) to [american inductor=$2L_2$] (1,-1)
(1,-3)--(2,-3)--(2,-4)--(0,-4);
\draw (2,-4)--(2,-3)--(3,-3)to[capacitor=$C_2/2$](3,-1)--(2,-1)--(2,0)
to[capacitor=$C_1$](4,0)to[american inductor=$L_1$](6,0)
(6,0)--(6,-1)--(5,-1)(5,-3)to[american inductor=$2L_2$](5,-1)(5,-3)--(6,-3)--(6,-4)--(2,-4);
\draw (8,-4)--(6,-4)--(6,-3)--(7,-3)to[capacitor,l_=$C_2/2$](7,-1)
--(6,-1)--(6,0)--(8,0);
\draw (0,0) node [ocirc] {} (8,0) node [ocirc] {} (0,-4) node [ocirc] {} (8,-4) node [ocirc] {};
\end{tikzpicture}
\end{document}