...
\begin{document}
	...
	declare function={w(\t)=2/sqrt(1-(\t*0.4)^2);}] plot [domain=0:2.3, samples=3000,
	smooth] (\x,{w(\x)});
	\draw [dashed](0,2.3) node [left]{1.15}--(1.25,2.3) (1.25,0) node[below]{0.5} --(1.25,2.3)
	(2.5,0) node [below]{1}--(2.5,5);
	\end{tikzpicture}
\end{document}